  ...
  return (
    <>
      ...
      <div
        ...
        className="relative flexBetween ml-4 sm:ml-0 sm:mt2 min-w-190 cursor-pointer
     dark:bg-nft-black-2 bg-white border dark:border-nft-black-2 border-nft-gray-2 px-4 py-1 rounded-md "
      >
