    ...
    <>
      <div className="flex-1 flexCenter dark:bg-nft-black-2 bg-white border dark:border-nft-black-2 border-nft-gray-2 px-4 py-3 rounded-md">
        ...
        <input
          ...
          className="dark:text-white dark:bg-nft-black-2 bg-white mx-4 w-full text-nft-black-1
      ...
      <div
        onClick={() => setToggle((prveToggle) => !prveToggle)}
        className="relative flexBetween ml-4 sm:ml-0 sm:mt-2 min-w-190 cursor-pointer
     dark:bg-nft-black-2 bg-white border dark:border-nft-black-2 border-nft-gray-2 px-4 py-3 rounded-md "
      >
